...
export const filterAffairs = (initialState: Array<AffairType>, filter: FilterType): Array<AffairType> => { // need to fix any

    if (filter === "all") {
        return initialState
    }
    return initialState.filter(a => a.priority === filter) // need to fix
}
